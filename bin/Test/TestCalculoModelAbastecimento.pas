...
type
  ...
  public
    ...
    [Test]
    [TestCase('Teste para conferir o valor do Imposto calculado pela rotina.','100,3.50,13,13')]
    procedure ConferirValorImposto(const pValorAbastecimento, pValorCombustivel, pValorImposto, Result: Double);

    [Test]
    [TestCase('Teste para conferir a quantidade de litros abastecidos calculado pela rotina.','100,3.50,13,28.57')]
    procedure ConferirQuantidadeLitrosAbastecidos(const pValorAbastecimento, pValorCombustivel, pValorImposto, Result: Double);

    [Test]
    [TestCase('Teste para conferir o Subtotal calculado pela rotina.','100,3.50,13,87')]
    procedure ConferirValorSubtotal(const pValorAbastecimento, pValorCombustivel, pValorImposto, Result: Double);

    [Test]
    [TestCase('Teste para conferir o valor total calculado pela rotina.','100,3.50,13,100')]
